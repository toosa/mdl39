...
class plugin_line extends pluginbase {
    ...
    function init() {
        ...
        $this->reporttypes = array('timeline', 'sql', 'assignment', 
                            ...
                            'usercourses', 'userquizzes', 'usersresources', 'usersscorm', 'forum', 'myforums', 'assignstatus', 'userattendance', 'attendanceoverview', 'resources', 'coursecompetency', 'bigbluebutton');
    }
