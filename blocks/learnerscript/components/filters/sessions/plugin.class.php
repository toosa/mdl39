...
class plugin_sessions extends pluginbase {
    ...
    public function filter_data($selectoption = true){
        ...
        if($selectoption && !in_array('sessions', $this->reportclass->basicparams[0])){
            $sessionoptions[0] = $this->singleselection ?
                get_string('filter_session', 'block_learnerscript') : get_string('select') .' '. get_string('sessions', 'block_learnerscript');
        }
    ...
    public function print_filter(&$mform) {
        ...
        $select = $mform->addElement('select', 'filter_session', get_string('sessions', 'block_learnerscript'), $sessionoptions, array('data-select2'=>1));
